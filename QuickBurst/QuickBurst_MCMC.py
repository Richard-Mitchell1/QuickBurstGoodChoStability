...
def run_qb(N_slow, T_max, n_chain, pulsars, max_n_wavelet=1, min_n_wavelet=0, n_wavelet_prior='flat', n_wavelet_start='random', RJ_weight=2, glitch_RJ_weight=2,
            ...
            save_every_n=10, savepath=None, resume_from=None, start_from=None, n_status_update=100, n_fish_update=1000, n_fast_to_slow=1000, thin = 100, write_run_parameters_to_file = True, data_directory = "", save_file = ""):
    ...
    :param save_file:
        The name of the file of that stores the run configuration. I recommend making it a similar name to the file the actual chain data is stored in.   
    """
    ...
    if write_run_parameters_to_file:
        ...
        run_data['thin'] = thin
        with open(data_directory + "run_data_" + save_file + ".json","w") as file:
